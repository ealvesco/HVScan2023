...
//gSystem->mkdir(("../results/"+chamber_).c_str());
	if(fitparamEff[0] >= 9.75){ 
 		c1->SaveAs(("../pngProducer_splitWpEndcapMaxCut/"+name_+"_CLSvsHV_WpEndcapMaxCut.png").c_str());
...
void pngProducer_splitWpEndcapMaxCut(const char* subdetect){
