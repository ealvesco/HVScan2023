...
//gSystem->mkdir(("../results/"+chamber_).c_str());
	if(fitparamEff[0] >= 9.7){ 
 		c1->SaveAs(("../pngProducer_splitWpBarrelMaxCut/"+name_+"_CLSvsHV_WpBarrelMaxCut.png").c_str());
...
void pngProducer_splitWpBarrelMaxCut(const char* subdetect){
